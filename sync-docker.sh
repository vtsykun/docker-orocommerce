...
docker build 3.1/ --tag='okvpn/orocommerce:4.1.0-rc' --build-arg ORO_PLATFORM=4.1.0-rc
docker push 'okvpn/orocommerce:4.1.0-rc'
docker build 3.1/ --tag='okvpn/orocommerce:4.1' --build-arg ORO_PLATFORM=4.1.0-rc
