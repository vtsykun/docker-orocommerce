...
# Auto generated at 2021-01-01T22:50:08+00:00
...
docker build 4.1/ --tag='okvpn/orocommerce:4.1.11' --build-arg ORO_PLATFORM=4.1.11 --memory=4000mb && docker push 'okvpn/orocommerce:4.1.11' || exitCode=$(( exitCode | $?))
docker build 4.1/ --tag='okvpn/orocommerce:4.1' --build-arg ORO_PLATFORM=4.1.11 --memory=4000mb && docker push 'okvpn/orocommerce:4.1' || exitCode=$(( exitCode | $?))
docker rmi 'okvpn/orocommerce:4.1.10' || true
docker rmi 'okvpn/orocommerce:4.1.11' || true
